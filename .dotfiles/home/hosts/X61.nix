# Home-Manager configuration for X61
# Backup machine (rust development + amateur radio backup)
...

{
  ...
  programs.zsh = {
    ...
    shellAliases = {
      ...
      homeSwitch = "home-manager switch --flake /home/jayden/.dotfiles/#jayden@X61";
    };
  };
  ...
  home.packages = with pkgs; [
    # ==== AMATEUR RADIO SOFTWARE (backup station) ====
    wsjtx
    xlog
    cqrlog
