# Home-Manager configuration for E5430
...

{
  ...
  programs.zsh = {
    ...
    shellAliases = {
      ...
      rebuildSwitch = "sudo nixos-rebuild switch --flake /home/jayden/.dotfiles/#E5430";
      homeSwitch = "home-manager switch --flake /home/jayden/.dotfiles/#jayden@E5430";
    };
  };
